...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MXCHIP_NSS_GPIO_Port, MXCHIP_NSS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : WRLS_SPI2_SCK_Pin WRLS_SPI2_MISO_Pin WRLS_SPI2_MOSI_Pin */
  GPIO_InitStruct.Pin = WRLS_SPI2_SCK_Pin|WRLS_SPI2_MISO_Pin|WRLS_SPI2_MOSI_Pin;
